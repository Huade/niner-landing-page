                ...
                {activeTabContent.details && (
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {activeTabContent.details.map((detail, index) => (
                      <div key={index} className="p-4 rounded-lg" style={{backgroundColor: 'var(--niner-secondary-50)'}}>
                        <h4 className="font-semibold mb-2" style={{color: 'var(--niner-secondary-900)'}}>
                          {detail.title}
                        </h4>
                        <p className="text-sm" style={{color: 'var(--niner-secondary-600)'}}>
                          {detail.description}
                        </p>
                      </div>
                    ))}
