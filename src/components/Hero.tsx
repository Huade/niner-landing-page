  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 niner-container text-center">
        <h1 ref={titleRef} data-gsap-hidden className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
        ...
        <p ref={subtitleRef} data-gsap-hidden className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed" style={{fontSize: 'var(--niner-text-lg)', lineHeight: '1.75'}}>
        ...
        <div ref={ctaRef} data-gsap-hidden className="flex justify-center">
